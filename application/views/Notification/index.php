...
<script> 
    var urls = '<?= base_url(); ?>backend/Notification/get_list';
    var add_urls = '<?= base_url(); ?>backend/Notification/form/add';
    var cekadd = <?= $bt_add?>;
...
<script type="text/javascript">
    //SEND EMAIL STATUS
    function myStatus(id, status, param, urls) {
    $.ajax({
        url: urls,
        type: "POST",
        data: {
