                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" id="formadd">
                             <div class="card-body">
                                 <div class="form-group row">
                                     <div class="col-sm-12">
                                        <textarea class="form-control" name="PrivacyPolicy" maxlength="250" id="summernote"><?= isset($all_data->PrivacyPolicy) ? $all_data->PrivacyPolicy : '' ?> </textarea>
                                   </div>
                                 </div>
                                 ...
                                 <div class="card-footer">
                                     <div class="form-actions form-group">
                                         <a href="<?= base_url("/backend/PrivacyPolicy") ?>" class="btn btn-danger float-right">Cancel</a>
 ...
 <script>
    ...
    $('#save').on('click', function(){
        var link = '<?php echo base_url('backend/PrivacyPolicy/update')?>';
        var form = 
        $.ajax({
            type: "post",
            url : link,
                  ...
                  if($.isEmptyObject(data.error)){                          
                    swal.fire({
                                ...
                                type: "success"
                                    ...
                                    window.location.href = "<?php echo base_url('backend/PrivacyPolicy/index')?>";
                            });
                    }else{
