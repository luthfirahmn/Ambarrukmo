       ...
       <div class="col-md-12">
         ...
         <div class="card card-info">
           ...
           <?php if ($status_edit == 0) : ?>
             <form class="form-horizontal" action="<?= base_url() ?>backend/module/add" method="post">
             <?php else : ?>
               <form class="form-horizontal" action="<?= base_url() ?>backend/module/edit" method="post">
               <?php endif; ?>
               <div class="card-body">
                 ...
                 <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                     <input type="text" name='file' class="form-control" id="inputEmail3" value="<?= isset($all_data->file) ? $all_data->file : '' ?>" placeholder="Enter Module File" required>
                   </div>
                 </div>
                 ...
                 <div class="form-group row">
                   ...
                   <div class="col-sm-10">
                     <input type="text" name='controllers' class="form-control" id="inputPassword3" value="<?= isset($all_data->controllers) ? $all_data->controllers : '' ?>" placeholder="Enter Module Controllers" required>
                   </div>
                 </div>
