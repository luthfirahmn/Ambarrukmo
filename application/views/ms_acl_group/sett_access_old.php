                                            ...
                                            <div id="collapseOne<?php echo $tag ?>" class="collapse show" data-parent="#accordion">
                                                <div class="card-body">
                                                    ...
                                                    <?php $checked = 'checked="checked"';?>
                                                        <label class="checkbox"><input type="checkbox" class="module_check" name="test[]" value="<?php echo $val->MView; ?>" <?php  $val->MView == 1 ? $checked :''?> />  View</label>
                                                        <label class="checkbox"><input type="checkbox" class="module_check" name="test[]" value="<?php echo $val->MAdd; ?>" <?php $val->MAdd == 1 ? 'checked="checked"' :''?> />  Add</label>
                                                        <label class="checkbox"><input type="checkbox" class="module_check" name="test[]" value="<?php echo $val->MEdit; ?>" <?php $val->MEdit == 1 ? 'checked="checked"' :''?> />  Edit</label>
                                                        <label class="checkbox"><input type="checkbox" class="module_check" name="test[]" value="<?php echo $val->MDelete; ?>" <?php $val->MDelete == 1 ? 'checked="checked"' :''?> />  Delete</label>
                                                        <label class="checkbox"><input type="checkbox" class="module_check" name="test[]" value="<?php echo $val->MPrint; ?>" <?php $val->MPrint == 1 ? 'checked="checked"' :''?> />  Print</label>
                                                        <label class="checkbox"><input type="checkbox" class="module_check" name="test[]" value="<?php echo $val->MExport; ?>" <?php $val->MExport == 1 ? 'checked="checked"' :''?> />  Export</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
