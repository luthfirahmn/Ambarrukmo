...
<script> 
   var urls = '<?= base_url(); ?>backend/VoucherMember/get_list';
    var add_urls = '<?= base_url(); ?>backend/VoucherMember/form/add';
    var cekadd = <?= $bt_add?>;
...
/*   function modal(id)
   {
        $.ajax({
                    url: "<?php echo base_url() ?>VoucherMember/detailvoucher",
                    method: "POST",
                    data: {id:id},
   ...
   {
        $.ajax({
                    url: "<?php echo base_url() ?>backend/VoucherMember/detailvoucher",
                    method: "POST",
                    data: {id:id},
                    success: function(data){
                        $('#result').html(data);
