...
class FAQ extends CI_Controller
{
  	...
  	public function index()
  	{
	    ...
	    $result = $query->row();
			...
			/** DATA SEND TO VIEW */  
	    $data_content                 = array();
	    $data_content['title']        = 'FAQ';
	    $data_content['breadcrumb']   = 'Dashboard';
	    $data_content['breadcrumb1']  = 'FAQ';
	    $data_content['data_tabel']   = 'DataTable FAQ';
	    $data_content['all_data']     = $result;

	    $config["content_file"] = "AppInfo/FAQ";
	...
	{   
	    ...
	    $this->form_validation->set_rules('FAQ','Text Field', 'required');
	    ...
	    else
	    {
	        ...
	        $page         = base_url('backend/AppInfo/FAQ');
